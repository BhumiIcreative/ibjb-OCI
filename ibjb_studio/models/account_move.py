...
class AccountInvoice(models.Model):
    ...
    vat_customer = fields.Char(related="partner_id.vat", string="Customer VAT No.",
    ...
    oci_compta_langcustomer = fields.Selection([],
                                               help="All emails and documents sent to this contact will be translated "
                                                    "into this language.", string="Customer language")
